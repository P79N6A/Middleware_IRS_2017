 ...
 * Date: 9/23/2015
 *
DEFINE_XEN_GUEST_HANDLE(cpu_user_regs_compat_t);
**/
...
# define runstate_guest(v) ((v)->runstate_guest)
     ...
     *
     *
#define ctxt_guest(v) ((v)->ctxt_guest)
    XEN_GUEST_HANDLE(cpu_user_regs_t) ctxt_guest;
    * End of Mod */
...
# define runstate_guest(v) ((v)->runstate_guest.native)
     ...
     *
     *
#define ctxt_guest(v) ((v)->ctxt_guest.native)
    union {
        XEN_GUEST_HANDLE(cpu_user_regs_t) native;
        XEN_GUEST_HANDLE(cpu_user_regs_compat_t) compat;
    } ctxt_guest;
    * End of Mod */
 ...
 *
 *
void vcpu_ctxt_get(struct vcpu* v, struct cpu_user_regs* ctxt);
**/
